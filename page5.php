...
$texts = [
        "Останній масив демонструє однакову структуру з попередніми.",
        "Він містить три абзаци, щоб зберегти узгодженість прикладу.",
        "Таким чином, можна створювати будь-яку кількість тестових блоків."
];
            ...
            <div class="body">
                <div class="left-content">
                    ...
                    <div style="width: 100%; display: flex; justify-content: center">
                        <img src="images/picture5.jpg" style="max-width: 30vw; max-height: 50vh"/>
                    </div>
                </div>
